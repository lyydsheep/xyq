...
const file_auth_v1_auth_proto_rawDesc = "" +
	...
	"\ftransactions\x18\x01 \x03(\v2\x19.auth.v1.PointTransactionR\ftransactions\x12\x14\n" +
	...
	"\vAuthService\x12W\n" +
	"\x10SendRegisterCode\x12 .auth.v1.SendRegisterCodeRequest\x1a!.auth.v1.SendRegisterCodeResponse\x12?\n" +
	...
	"\x06Logout\x12\x16.auth.v1.LogoutRequest\x1a\x17.auth.v1.LogoutResponse2\xf1\x02\n" +
	"\vUserService\x12Q\n" +
	"\x0eGetCurrentUser\x12\x1e.auth.v1.GetCurrentUserRequest\x1a\x1f.auth.v1.GetCurrentUserResponse\x12Z\n" +
	"\x11UpdateCurrentUser\x12!.auth.v1.UpdateCurrentUserRequest\x1a\".auth.v1.UpdateCurrentUserResponse\x12N\n" +
	"\rGetUserPoints\x12\x1d.auth.v1.GetUserPointsRequest\x1a\x1e.auth.v1.GetUserPointsResponse\x12c\n" +
	"\x14GetPointTransactions\x12$.auth.v1.GetPointTransactionsRequest\x1a%.auth.v1.GetPointTransactionsResponseB\x15Z\x13auth/api/auth/v1;v1b\x06proto3"
...
var file_auth_v1_auth_proto_goTypes = []any{
	...
	(*GetCurrentUserRequest)(nil),        // 10: auth.v1.GetCurrentUserRequest
	(*GetCurrentUserResponse)(nil),       // 11: auth.v1.GetCurrentUserResponse
	(*UpdateCurrentUserRequest)(nil),     // 12: auth.v1.UpdateCurrentUserRequest
	(*UpdateCurrentUserResponse)(nil),    // 13: auth.v1.UpdateCurrentUserResponse
	(*GetUserPointsRequest)(nil),         // 14: auth.v1.GetUserPointsRequest
	(*GetUserPointsResponse)(nil),        // 15: auth.v1.GetUserPointsResponse
	(*GetPointTransactionsRequest)(nil),  // 16: auth.v1.GetPointTransactionsRequest
	(*GetPointTransactionsResponse)(nil), // 17: auth.v1.GetPointTransactionsResponse
	(*PointTransaction)(nil),             // 18: auth.v1.PointTransaction
	(*timestamppb.Timestamp)(nil),        // 19: google.protobuf.Timestamp
}
var file_auth_v1_auth_proto_depIdxs = []int32{
	19, // 0: auth.v1.GetCurrentUserResponse.created_at:type_name -> google.protobuf.Timestamp
	19, // 1: auth.v1.GetCurrentUserResponse.updated_at:type_name -> google.protobuf.Timestamp
	19, // 2: auth.v1.UpdateCurrentUserResponse.created_at:type_name -> google.protobuf.Timestamp
	19, // 3: auth.v1.UpdateCurrentUserResponse.updated_at:type_name -> google.protobuf.Timestamp
	18, // 4: auth.v1.GetPointTransactionsResponse.transactions:type_name -> auth.v1.PointTransaction
	19, // 5: auth.v1.PointTransaction.created_at:type_name -> google.protobuf.Timestamp
	19, // 6: auth.v1.PointTransaction.updated_at:type_name -> google.protobuf.Timestamp
	0,  // 7: auth.v1.AuthService.SendRegisterCode:input_type -> auth.v1.SendRegisterCodeRequest
	...
	8,  // 11: auth.v1.AuthService.Logout:input_type -> auth.v1.LogoutRequest
	10, // 12: auth.v1.UserService.GetCurrentUser:input_type -> auth.v1.GetCurrentUserRequest
	12, // 13: auth.v1.UserService.UpdateCurrentUser:input_type -> auth.v1.UpdateCurrentUserRequest
	14, // 14: auth.v1.UserService.GetUserPoints:input_type -> auth.v1.GetUserPointsRequest
	16, // 15: auth.v1.UserService.GetPointTransactions:input_type -> auth.v1.GetPointTransactionsRequest
	1,  // 16: auth.v1.AuthService.SendRegisterCode:output_type -> auth.v1.SendRegisterCodeResponse
	...
	11, // 21: auth.v1.UserService.GetCurrentUser:output_type -> auth.v1.GetCurrentUserResponse
	13, // 22: auth.v1.UserService.UpdateCurrentUser:output_type -> auth.v1.UpdateCurrentUserResponse
	15, // 23: auth.v1.UserService.GetUserPoints:output_type -> auth.v1.GetUserPointsResponse
	17, // 24: auth.v1.UserService.GetPointTransactions:output_type -> auth.v1.GetPointTransactionsResponse
